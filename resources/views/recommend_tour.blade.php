  ...
  <body>
    ...
    <div class="menu_siteBar">
      <div class="logoDashboard">
        <a href="">TOUR ADVICE</a>
      </div>
      <div class="Language">
          <div class="lan_title">
              <span>LANG</span><i class="fas fa-caret-down"></i>
          </div>
          <div class="lan_more">
      ...
      <div class="menuDashboard">
        <ul>
          <li class="li_menu_start">
            <p class="menu_title_start">START TOUR</p>
          </li>
          <li class="li_menu_acc">
            <p class="menu_title_acc" id="your_account">YOUR ACCOUNT <i class="fas fa-sort-down"></i></p>
    ...
    <!-- Footer-->
    <style>
      .footer{min-height: 15rem;margin-top: 60rem;
          padding-top: 5rem;
          padding-bottom: 5rem;
